...
//!
//! ```
//! use zensvg::{OptimizeOptions, optimize};
//!
...
//!
//! // Maximum compression: minify + SVGZ (gzip container).
//! let compressed = optimize(svg, &OptimizeOptions::max_compression()).unwrap();
//! assert!(!compressed.is_empty());
//!
//! // Input size limit (decompression-bomb protection).
//! let safe = optimize(
//!     svg,
//!     &OptimizeOptions::minify().with_max_input_bytes(10 * 1024 * 1024),
//! )
//! .unwrap();
//! assert_eq!(safe, minified);
//! ```
